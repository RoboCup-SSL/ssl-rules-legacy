...
\begin{itemize}
\item \added{no more than 15 seconds passed since the placement command}
\item \added{there is no robot within 500\,mm distance to the ball}
\item \added{the ball is stationary}
\item \added{the ball is at a position within 100\,mm radius from the requested position}
\end{itemize}
\added{
