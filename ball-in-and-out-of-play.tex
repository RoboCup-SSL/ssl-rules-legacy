...
\item For an indirect freekick, direct freekick or penalty kick, the team that brings the ball into play must place the ball. If the team fails to place the ball, an indirect free kick is awarded to the opposing team.
\item For a forced start, a team is drawn by chance and must place the ball. If this team fails, an indirect freekick is awarded to the opposing team.
\item The ball must be visible and must not be inside a field or goal corner, before the ball placement starts.
...
\added{
Ball placement is mandatory for all teams in Division A. Teams in Division B may decide, at any time before or during the game, not to place the ball for the rest of the game. In this case, the ball is placed by the opposing team, but it is still allowed to bring the ball into play afterwards. If the opposing team fails to place the ball or no team can place the ball, it is placed by the human referee.
}
