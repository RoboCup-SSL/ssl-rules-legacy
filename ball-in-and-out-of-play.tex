...
If, after the ball enters play \added{other than due to a forced restart}, the kicker touches the ball a second time (without holding the ball) before it has touched another robot:
\begin{itemize}
...
If, after the ball enters play \added{other than due to a forced restart}, the kicker deliberately holds the ball before it has touched another robot:
\begin{itemize}
...
\item a \removed{neutral}\added{forced} restart is indicated\added{, and}
\item \added{once the referee indicates the forced restart, robots from either team may approach and touch the ball}
\end{itemize}
