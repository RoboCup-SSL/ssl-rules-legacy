...
\begin{itemize}
\item \added{if a throw-in is kicked directly into the opponents' goal, a goal kick is awarded}
\item \added{if a throw-in is kicked directly into the team's own goal, a corner kick is awarded to the opposing team}
\end{itemize}
...
\begin{itemize}
\item \removed{T}\added{t}he referee places the ball at the designated position\removed{.}
\item \removed{A}\added{a}ll opponent robots are at least 500\,mm from the ball\removed{.}
\item \removed{T}\added{t}he ball is in play when it is kicked and moves\removed{.}
\end{itemize}
