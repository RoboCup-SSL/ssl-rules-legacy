...
\begin{itemize}
\item remains between the goalposts \removed{, touches its goal line, and faces outward of the goal,} \added{and touches its goal line} until the ball has been kicked; it is allowed to move before the ball has been kicked, as long as its motion does not break any of these constraints
\end{itemize}
