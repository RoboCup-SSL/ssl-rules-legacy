...
\added{The ball travels above 150\,mm from the ground before touching the goalkeeper, the crossbar, or the goal post or entering the goal:}

\begin{itemize}
\item \added{no goal is awarded and the kick is not retaken}
\end{itemize}
