...
\begin{figure}[ht] % ht = here / t = top / b = bottom
  \centering
  \includegraphics[width=0.8\columnwidth,bb=0 0 10733 8327]{img/quad-size-field.png}
...
\begin{figure}[ht] % ht = here / t = top / b = bottom
  \centering
  \includegraphics[width=0.8\columnwidth,bb=0 0 8327 5928]{img/double-size-field.png}
...
The two longer \added{boundary lines} \removed{sides} are called touch \added{lines} \removed{boundaries}.
The two shorter \added{boundary lines} \removed{sides} are called goal \added{lines} \removed{boundaries}.
...
For each field half the penalty mark is 1200\,mm \added{for Division A and 1000\,mm for Division B}, from the midpoint between the goalposts and equidistant to them, thus coinciding with the outer edge of the defence area. \removed{The mark is a 10 mm diameter circle of white paint}

\subsection{Goals}
Goals must be placed on the centre of each goal \added{line} \removed{boundary} and anchored
...
enclose\added{, excluding robots}) from the time the teams enter the field of 
