...
\begin{itemize}
\item
\removed{all robots are in their own half of the field}
\added{each robot is located at least partially in its own half of the field}
...
\added{\item up to one robot of the team taking the kick-off is allowed to leave its own half of the field,
as long as this robot stays within the center circle and no other robot touches the ball}
\item the ball is in play when is kicked and moves \removed{forward}
