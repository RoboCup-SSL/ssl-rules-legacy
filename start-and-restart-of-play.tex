...
\subsubsection{Procedure}
The \removed{referee places the ball at the place} \added{ball must be placed} where it was located when play was stopped, unless
play was stopped in an illegal free kick position, as described in Section~\ref{sec:free-kicks},
in which case the \removed{referee places the ball} \added{ball must be placed} in the closest legal free kick position.
