...
\added{
For every third yellow card a red card is shown instead.
}
A team is \added{also} shown a red card if one of the robots or the team is guilty of severe unsporting behaviour.
