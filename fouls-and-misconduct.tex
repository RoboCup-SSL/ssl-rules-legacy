...
\fi
\item \added{is the last robot to touch the ball before it travels more than 150\,mm from the ground, then while above that height the ball touches the opposing goalkeeper, then the ball enters the opposing goal without subsequently touching any other robot except the opposing goalkeeper}
