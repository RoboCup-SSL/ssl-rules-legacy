...
\fi
\item \added{is the last robot to touch the ball before the top of the ball travels more than 150\,mm from the ground, then the ball touches the opposing goalkeeper, then the ball enters the opposing goal without subsequently touching any other robot except the opposing goalkeeper}
