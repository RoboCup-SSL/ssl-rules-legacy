...
\item
The robot speed limit described in \autoref{subsec:fouls-and-misconduct-disciplinary-sanctions} applies only to cases where \removed{the} Referee Box is reporting the STOP command during normal play or a penalty shoot\added{-}out.
