...
\subsection{Duties}
The \removed{assistant referee}\added{Referee Box operator} is appointed whose duties, subject to the decision of the referee, are to:
\begin{itemize}
...
The \removed{assistant referees}\added{Referee Box operators} also assist the referee to control the match in accordance with the Laws of the Game.
In the event of undue interference or improper conduct, the referee will relieve an \removed{assistant referee}\added{Referee Box operator} of his duties and make a report to the organising committee.
