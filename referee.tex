...
\item stops, suspends\added{,} or terminates the match, at his discretion, for any infringements of the Laws
\item stops, suspends\added{,} or terminates the match because of outside interference of any kind
\item stops the match if, in his opinion, a robot is likely to cause serious harm to humans, other robots\added{,} or itself and ensures that it is removed from the field of play
\item repositions the ball to a neutral position if it becomes stuck during play
...
\item takes disciplinary action against robots guilty of cautionable and sending-off offences\removed{. H}\added{; h}e is not obliged to take this action immediately but must do so when the ball next goes out of play
\item takes action against team officials who fail to conduct themselves in a responsible manner and may\added{,} at his discretion, expel them from the field of play and its immediate surrounds
...
\item provides the technical committee with a match report which includes information on any disciplinary action taken against team officials and any other incidents which occurred before, during\added{,} or after the match
...
\item halts the game whenever Vision Expert(s) ask during a match and lets the Vision Expert(s) diagnose and fix the issue\removed{. I}\added{; i}f the Vision Expert(s) confirm that the issue is resolved then the game must restart instantly
\end{itemize}
...
A device will be supplied to convert the referee's signals into \removed{e}\added{E}thernet communication signals that are transmitted to both teams.
...
The whistle signal indicates that the referee has stopped play\removed{,} and that all robots should move 500\,mm from the ball to allow the referee to place the ball for a restart.
...
\item any other loss suffered by any individual, club, company, association\added{,} or other body, which is due or which may be due to any decision which he may take under the terms of the Laws of the Game or in respect of the normal procedures required to hold, play\added{,} and control a match\removed{.}
\end{itemize}
...
\item a decision to allow or not to allow a robot to have certain colo\removed{u}rs
\item a decision (in so far as this may be his responsibility) to allow or not to allow any persons (including team or stadium officials, security officers, photographers\added{,} or other media representatives) to be present in the vicinity of the field of play
...
\item
The referee may be assisted by an autonomous referee application provided by one or both of the competing teams, if both teams agree.
The referee may also be assisted by an autonomous or semi-autonomous application provided by a team not participating in the current match, at the referee's own discretion, provided that the application is operated or monitored by a neutral party.

\item
The outer region of the field surface which is further than 250\added{\,}mm away from the boundary line is used as a designated walking area by the referee and/or assistant referee during gameplay.
