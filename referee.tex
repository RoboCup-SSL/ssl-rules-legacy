...
Signals indicating periods of timeout and time lost will also be sent when required.
...
\item a decision to allow or not to allow a robot to have certain colours
