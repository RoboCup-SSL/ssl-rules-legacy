...
Referee Box is operated by the Referee Box operator.}
...
The \removed{assistant referee}\added{Referee Box operator} will send signals reflecting the referee's call over communication links to each team.
...
The referee will be deemed to have given a signal when the \removed{assistant referee}\added{Referee Box operator} has relayed that signal over the communications links.
