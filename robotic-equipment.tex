...
\removed{Standardized colored paper or cardstock for all required colors will be provided at the competition.}
\added{All markers must be cut from stock specified by the SSL-Vision documentation; teams are responsible for obtaining the specified paper stock and preparing their markers.}
