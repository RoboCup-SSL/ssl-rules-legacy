...
\begin{itemize}
\item \removed{interchange} \added{removal of robots from the game} can only be made during a stoppage in play,
...
\added{If the robot being replaced was located within 1 meter distance to a touch line and the halfway line, the interchange robot may enter the field immediately. Otherwise, it enters the field at the next stoppage of the game.}
