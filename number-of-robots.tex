...
\subsection{Robots}
A match is played by two teams, each consisting of not more than \removed{six robots} \added{eight robots in Division A and six robots in Division B}, one of which may be the goalkeeper.
...
\added{
\item when an automatic referee is used
\begin{itemize}
	\item the Referee Box operator is informed before ball placement is finished,
	\item the Referee Box operator pauses the automatic referee until the interchange is done,
\end{itemize}
}
...
\item the interchange robot enters the field of play at \added{either edge of} the halfway line.
\end{itemize}
